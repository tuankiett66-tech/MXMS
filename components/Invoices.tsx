      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white rounded-lg p-8 shadow-2xl border border-slate-200 relative text-black" id="invoice-print" style={{ color: '#000' }}>
          ...
          <div className="space-y-2 mb-4 font-medium text-black">
            ...
            <div className="invoice-line">
              <span className="invoice-label">- Số ngày nghỉ có phép : {inv.calculationInfo.absentDaysLastMonth} ngày. Trừ lại</span>
              <span className="invoice-dots">:</span>
              <span className="invoice-value">{formatCurrency(inv.calculationInfo.absentDaysLastMonth * config.mealFeePerDay)} đồng.</span>
            </div>
          </div>
